    ...
    private void setupAdapter(Graph graph) {
        ...
        adapter = new BaseGraphAdapter<ViewHolder>(this, R.layout.node, graph) {
            ...
            public void onBindViewHolder(ViewHolder viewHolder, Object data, int position) {
                ...
                if (position == 0) {
                    viewHolder.cardView.setBackgroundColor(getResources().getColor(android.R.color.holo_purple));
                } else if (position > 0 && position <= 2) {
                    viewHolder.cardView.setBackgroundColor(getResources().getColor(android.R.color.holo_green_light));
                } else if (position > 2 && position <= 7) {
                    viewHolder.cardView.setBackgroundColor(getResources().getColor(android.R.color.holo_orange_light));
                }
            }
        };
